      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item" style="margin-right:40px; margin-bottom:15px; margin-top: 20px;">
            <a href="logout.php" class= "btn btn-danger mx-5" style = "float:right; display:block;">Logout</a>
            </li>
